...
The codebook also carries a `universe` column giving the Census
Bureau's published universe statement for each variable--the
population the variable describes, e.g., `Households` or
`Population 25 years and over`. Derived variables inherit the
universe of their numerator. (The Census API publishes universe
statements for the 2020 and later vintages; earlier vintages yield
`NA`.) Supporting columns are used for margin-of-error
