...
variables (percentages, complements, etc.). But you can also define your own derived
variables using the `define_*()` helpers and then pass these definitions directly to
