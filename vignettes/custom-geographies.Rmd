...
tract-level (or really any level of data) data to user-defined geographies (e.g., neighborhoods,
...
the share of population receiving SNAP benefits across areas "quadrants".
...
smaller coefficients of variation. Indeed, the median coefficient of variation
for tract level is greater than 30, a common upper bound for "reliable" estimates.
...
statistically significant differences at greater geographic scales.
This enables analysis for more policy-relevant areas and helps mitigate
shortcomings associated with high measures of error for smaller-population
observations, which can lead to findings of no statistically significant differences.
...
3.  **More relevant units of analysis**: The ACS reports estimates at 
    ...
    Think neighborhoods, wards, continuums of care, school districts, and more.
    To robustly calculate errors and draw reliable inferences for these
    other geographies is critical but challenging.  
