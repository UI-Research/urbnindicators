...
`interpolate_acs()` helps make your analysis more precise and relevant to decisionmaking contexts:
...
1.  **Aggregation improves precision**: Combining geographies into larger
    ...
    areas? Aggregate adjacent geographies to get estimates with smaller (relative) MOEs.
