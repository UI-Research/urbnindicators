    ...
    dplyr::mutate(
      ...
      clean_names = paste0(
        ...
        stringr::str_replace_all(c(
          ...
          "american_indian_alaska_native" = "native", ## should update this in the future; native is overly-inclusive for this subset of Indigenous people
...
list_acs_variables = function(year = "2022") {
  ...
  variables = c(
    ...
    median_hh_income_universe_ = "B19013_001",
    ...
    median_hh_income_pacificislander_ = "B19013E_001",
    ...
    federal_poverty_limit_universe_native_alone_ = "B17020C_001",
    ...
    federal_poverty_limit_below_native_alone_ = "B17020C_002",
    ...
    race_hispanic_native_alone_ = "B03002_015",
    ...
    race_hispanic_twoormore_includingother_ = "B03002_020",
