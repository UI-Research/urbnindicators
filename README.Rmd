...
-   Margins of error and coefficients of variation for all variables--those direct
    from the API as well as derived variables.
...
-   A package overview to help users [**Get Started**](articles/urbnindicators.html).
